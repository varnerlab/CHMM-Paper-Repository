...
`paper/figs/` are copied from that repo's `figs/` after each rebuild.
...
Target output: `paper/paper.pdf` with zero undefined citations or references.
...
`CHMM-paper/paper/figs/` before rebuilding the manuscript.
