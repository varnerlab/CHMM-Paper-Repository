...
% Force \FloatBarrier before every \subsection so floats cannot cross into the
% next subsection, eliminating orphan headings followed by tall whitespace
% (the \texttt{[section]} option of \texttt{placeins} only barriers at \section).
