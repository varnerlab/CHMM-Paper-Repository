...
Second, CHMM-t -- despite overshooting the empirical kurtosis by $\sim 126\%$ IS -- does \emph{not} produce a systematically more conservative VaR/ES estimate: its IS median VaR$_{0.01}$ of $-6.58$ is almost identical to CHMM-N's $-6.64$, and its envelope width is comparable.
