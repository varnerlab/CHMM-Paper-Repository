...
CHMM-t is therefore the CHMM family that passes both tests at both confidence levels with margin; CHMM-L clears all four thresholds but marginally at the $5\%$ Kupiec ($\text{LR}_{\text{uc}} = 3.83$ against a $\chi^2_1$ critical value of $3.84$), while CHMM-N still fails Christoffersen independence at $1\%$ even after conditioning.
