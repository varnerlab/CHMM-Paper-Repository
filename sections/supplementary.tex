...
This appendix collects the full Pipeline~B detail: cross-asset dependence model derivations and diagnostics, the Student-t copula profile log-likelihood, the cross-asset correlation heat maps, the non-US asset-class extension and per-pair OoS off-diagonal breakdown, and the per-asset KS bar chart.
