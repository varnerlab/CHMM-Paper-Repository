...
\textbf{CHMM-N ($K = 18$)}           & $93.8$ & $84.2$ & $4.99$  & $4.51$  & $\mathbf{0.0507}$ & $\mathbf{1.0384}$ \\
...
A walk-forward quarterly refit lifts JPM OoS KS from $49.0\%$ to $64.3\%$, recovering $15.3$ percentage points of the gap (Appendix Table~\ref{tab:walk_forward}); we acknowledge the residual cliff as a stationarity-scope limitation rather than a model-selection issue (it persists at every $K$ in the sweep).
