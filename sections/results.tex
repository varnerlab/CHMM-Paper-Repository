...
Figure~\ref{fig:cross_asset_corr} visualises the observed and path-averaged simulated correlation matrices for the three dependence models; the per-asset in-sample KS pass rates as a grouped bar chart (Figure~\ref{fig:cross_asset_ks}) are deferred to Appendix~\ref{sec:cross_asset_ks_supp}.
...
\begin{figure}[t]
\centering
\includegraphics[width=0.85\textwidth, trim=0 430 0 0, clip]{figs/Fig-Cross-Asset-Correlation.pdf}
