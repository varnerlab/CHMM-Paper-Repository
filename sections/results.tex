...
All rows are computed at \NPaths{1{,}000} simulated paths on both the \TIS{2{,}516} and \TOoS{572} SPY windows under the seed policy of Section~\ref{sec:metrics}; full numerical panels in Tables~\ref{tab:extended_metrics}--\ref{tab:sim_pvalues}.
