...
ACF-MAE (0.0564) and $W_1$ (0.102) are within 10\% of the CHMM-N values, and IS quantile coverage is 100\%.
...
GARCH's $\text{MMD}^2 = 0.0$ on IS is a bandwidth-heuristic artefact (the median heuristic widens to accommodate GARCH's overdispersed windows); the OoS comparison ($\text{GARCH} = 7.5 \times 10^{-4}$ vs.\ CHMM-N $6.1 \times 10^{-4}$) resolves it.
