...
\end{subfigure}
\caption{JNJ out-of-sample price fan and terminal distribution, CHMM-N (Pipeline~A, $K = 18$, 500 simulated paths, $T_{\text{OoS}} = 572$; plotting conventions as in Figure~\ref{fig:price_fan_spy}).}
...
\begin{subfigure}[t]{0.45\textwidth}
    ...
    \caption{Terminal distribution.}
\end{subfigure}
\caption{JPM out-of-sample price fan and terminal distribution, CHMM-N (Pipeline~A, $K = 18$, 500 simulated paths, $T_{\text{OoS}} = 572$; plotting conventions as in Figure~\ref{fig:price_fan_spy}).}
...
\begin{subfigure}[t]{0.45\textwidth}
    ...
    \caption{Terminal distribution.}
\end{subfigure}
\caption{AAPL out-of-sample price fan and terminal distribution, CHMM-N (Pipeline~A, $K = 18$, 500 simulated paths, $T_{\text{OoS}} = 572$; plotting conventions as in Figure~\ref{fig:price_fan_spy}).}
...
\begin{subfigure}[t]{0.45\textwidth}
    ...
    \caption{Terminal distribution.}
\end{subfigure}
\caption{QQQ out-of-sample price fan and terminal distribution, CHMM-N (Pipeline~A, $K = 18$, 500 simulated paths, $T_{\text{OoS}} = 572$; plotting conventions as in Figure~\ref{fig:price_fan_spy}).}
