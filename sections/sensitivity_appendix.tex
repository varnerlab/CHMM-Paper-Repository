...
Figures~\ref{fig:k_sweep_panels_is}--\ref{fig:k_sweep_is_k21} show the in-sample model comparison panels for $K \in \{3, 6, 9, 12, 15, 21\}$, complementing the $K = 18$ comparison in Figure~\ref{fig:is_comparison} of the main text.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{figs/Fig-3-IS-Comparison-K3.pdf}
\caption{In-sample CHMM comparison at $K = 3$. The $K = 18$ counterpart is Figure~\ref{fig:is_comparison} of the main text.}
\label{fig:k_sweep_panels_is}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{figs/Fig-3-IS-Comparison-K6.pdf}
\caption{In-sample CHMM comparison at $K = 6$.}
\label{fig:k_sweep_is_k6}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{figs/Fig-3-IS-Comparison-K9.pdf}
\caption{In-sample CHMM comparison at $K = 9$.}
\label{fig:k_sweep_is_k9}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{figs/Fig-3-IS-Comparison-K12.pdf}
\caption{In-sample CHMM comparison at $K = 12$.}
\label{fig:k_sweep_is_k12}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{figs/Fig-3-IS-Comparison-K15.pdf}
\caption{In-sample CHMM comparison at $K = 15$.}
\label{fig:k_sweep_is_k15}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{figs/Fig-3-IS-Comparison-K21.pdf}
\caption{In-sample CHMM comparison at $K = 21$.}
\label{fig:k_sweep_is_k21}
\end{figure}

\subsection{Out-of-Sample Validation at Non-Selected State Resolutions}

Figures~\ref{fig:k_sweep_panels_oos}--\ref{fig:k_sweep_oos_k21} show the out-of-sample validation panels for $K \in \{3, 6, 9, 12, 15, 21\}$.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{figs/Fig-4-OoS-Validation-K3.pdf}
\caption{Out-of-sample CHMM validation at $K = 3$. The $K = 18$ counterpart is Figure~\ref{fig:oos_validation} of the main text.}
\label{fig:k_sweep_panels_oos}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{figs/Fig-4-OoS-Validation-K6.pdf}
\caption{Out-of-sample CHMM validation at $K = 6$.}
\label{fig:k_sweep_oos_k6}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{figs/Fig-4-OoS-Validation-K9.pdf}
\caption{Out-of-sample CHMM validation at $K = 9$.}
\label{fig:k_sweep_oos_k9}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{figs/Fig-4-OoS-Validation-K12.pdf}
\caption{Out-of-sample CHMM validation at $K = 12$.}
\label{fig:k_sweep_oos_k12}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{figs/Fig-4-OoS-Validation-K15.pdf}
\caption{Out-of-sample CHMM validation at $K = 15$.}
\label{fig:k_sweep_oos_k15}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{figs/Fig-4-OoS-Validation-K21.pdf}
\caption{Out-of-sample CHMM validation at $K = 21$.}
\label{fig:k_sweep_oos_k21}
\end{figure}

\subsection{ACF Comparison Across State Resolutions}

Figures~\ref{fig:acf_all}--\ref{fig:acf_k18} show the ACF of $|G_t|$ for the CHMM at $K = 3$, $K = 12$, and $K = 18$, compared to the observed ACF.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{figs/Fig-ACF-Comparison-K3.pdf}
\caption{ACF of $|G_t|$ for the CHMM at $K = 3$. The simulated 10th--90th percentile envelope (shaded) envelopes the observed ACF (red dashed).}
\label{fig:acf_all}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{figs/Fig-ACF-Comparison-K12.pdf}
\caption{ACF of $|G_t|$ for the CHMM at $K = 12$.}
\label{fig:acf_k12}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{figs/Fig-ACF-Comparison-K18.pdf}
\caption{ACF of $|G_t|$ for the CHMM at $K = 18$ (selected). Consistent with Figures~\ref{fig:acf_all} and~\ref{fig:acf_k12}, the CHMM reproduces volatility clustering without jump augmentation across the entire sweep.}
\label{fig:acf_k18}
\end{figure}
...
\centering
\begin{subfigure}[b]{0.32\textwidth}
    \includegraphics[width=\textwidth]{figs/Fig-Stationary-Distribution-K18-N.pdf}
    \caption{CHMM-N}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.32\textwidth}
    \includegraphics[width=\textwidth]{figs/Fig-Stationary-Distribution-K18-t.pdf}
    \caption{CHMM-t}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.32\textwidth}
    \includegraphics[width=\textwidth]{figs/Fig-Stationary-Distribution-K18-L.pdf}
    \caption{CHMM-L}
\end{subfigure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{figs/Fig-3-IS-Comparison-K18-t.pdf}
\caption{In-sample model comparison at $K = 18$ for CHMM-t. Panels show (a) marginal density with KS pass rate, (b) ACF of $|G_t|$, and (c) tail Q-Q plot. The CHMM-N counterpart is Figure~\ref{fig:is_comparison}; the CHMM-L counterpart is Figure~\ref{fig:is_families_L}.}
\label{fig:is_families}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{figs/Fig-3-IS-Comparison-K18-L.pdf}
\caption{In-sample model comparison at $K = 18$ for CHMM-L. Panels as in Figure~\ref{fig:is_families}.}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{figs/Fig-4-OoS-Validation-K18-t.pdf}
\caption{Out-of-sample validation at $K = 18$ for CHMM-t. Panels show (a) KS $p$-values, (b) OoS density fan, and (c) OoS ACF of $|G_t|$. The CHMM-N counterpart is Figure~\ref{fig:oos_validation}; the CHMM-L counterpart is Figure~\ref{fig:oos_families_L}.}
\label{fig:oos_families}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{figs/Fig-4-OoS-Validation-K18-L.pdf}
\caption{Out-of-sample validation at $K = 18$ for CHMM-L. Panels as in Figure~\ref{fig:oos_families}.}
