This appendix documents the precise form of the seven per-path metrics referenced in the body evaluation protocol.
...
The median and $[5\%, 95\%]$ envelopes across simulated paths are visualised in Fig.~\ref{fig:var_es}; the numeric values are reported in Table~\ref{tab:var_es}.
