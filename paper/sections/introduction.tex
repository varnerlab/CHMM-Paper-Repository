...
\begin{enumerate}
    ...
    \item \textbf{Cross-asset generalization} to NVDA, JNJ, and JPM, confirming that the framework adapts to diverse risk profiles without modification.
\end{enumerate}

The continuous emission structure also provides a natural foundation for future extensions incorporating stochastic volatility dynamics within the regime-switching framework---a direction that the discrete quantile-binning approach cannot support.
