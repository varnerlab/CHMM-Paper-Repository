...
All rows are computed at $N_{\text{paths}} = 1{,}000$ simulated paths, seed $20260422$, on both the $T_{\text{IS}} = 2{,}516$ and $T_{\text{OoS}} = 572$ SPY windows.
...
The Discrete NJ signature-MMD is anomalously low ($9 \times 10^{-5}$) because the bin-centroid emission produces a piecewise-constant path whose depth-$3$ signature is near-zero by construction; we flag this artefact and treat the row as non-informative for this metric.
...
At the $5\%$ level, the discrete HMM with Poisson jumps baseline of \citet{alswaidan2026hybrid} and its no-jump variant both over-conservatively produce a breach rate of $1.75\%$ against a target of $5\%$, which rejects Kupiec decisively with $\text{LR}_{\text{uc}} = 16.81$ and $p < 0.001$.
...
\centering
\small
\caption{\textbf{Extended evaluation panel} (Pipeline A, SPY, IS $= 2{,}516$ and OoS $= 572$, $N_{\text{paths}} = 1{,}000$). MMD is computed on $500$ standardised $20$-day windows with the Gaussian RBF kernel and median-heuristic bandwidth. Signature-MMD is depth $3$ on the time-lifted $2$D path $(t/W, r_t / \operatorname{std}(r))$. Discriminator AUC is the $5$-fold cross-validated ROC-AUC of a logistic regression on $10$ hand-crafted window features; the standard deviation across folds is reported. Lower MMD and Signature-MMD is better; discriminator AUC closer to $0.50$ is better. GARCH MMD IS is a bandwidth-heuristic artefact and should be read through its OoS value; Discrete NJ Signature-MMD IS is a quantization artefact. Reproduced from \texttt{results/track\_a/Table-4-Extended-Metrics.txt}.}
...
Discrete NJ & $3.91\!\times\!10^{-3}$ & $4.49\!\times\!10^{-3}$ & $9.0\!\times\!10^{-5}$  & $4.89\!\times\!10^{-3}$ & $0.729 \pm 0.037$ & $0.767 \pm 0.039$ \\
Discrete WJ & $2.69\!\times\!10^{-3}$ & $7.29\!\times\!10^{-3}$ & $1.66\!\times\!10^{-3}$ & $9.27\!\times\!10^{-3}$ & $0.728 \pm 0.040$ & $0.754 \pm 0.023$ \\
...
Discrete NJ & $-0.009$ & $\phantom{-}0.296$ & $0.000$ & $-0.009$ & $\phantom{-}0.292$ & $0.001$ \\
Discrete WJ & $-0.009$ & $\phantom{-}0.295$ & $0.000$ & $-0.007$ & $\phantom{-}0.289$ & $0.000$ \\
...
Discrete NJ & $0.63$ & $0.77$ & $0.40$ & $0.01$ & $0.64$ & $0.53$ & $0.00$  & $-0.47$ \\
Discrete WJ & $0.53$ & $0.71$ & $0.35$ & $0.01$ & $0.51$ & $0.41$ & $-0.01$ & $-0.47$ \\
...
Discrete NJ & $0.000$ & $0.000$ & $0.000$ & $0.000$ & $0.007$ & $0.002$ & $0.163$ \\
Discrete WJ & $0.000$ & $0.000$ & $0.000$ & $0.000$ & $0.001$ & $0.000$ & $0.164$ \\
...
Both Discrete NJ and Discrete WJ produce an OoS $5\%$ VaR breach rate of exactly $1.75\%$, roughly one-third of the $5\%$ target; the Kupiec likelihood-ratio statistic $\text{LR}_{\text{uc}} = 16.81$ rejects unconditional coverage with $p < 10^{-3}$, and the independence statistic $\text{LR}_{\text{ind}} = 13.22$ also rejects.
