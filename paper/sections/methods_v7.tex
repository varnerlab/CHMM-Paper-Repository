...
The VIX extensions use daily closes over approximately 2006--2024 with the same 2025 out-of-sample window.
...
The model is trained for $20$ epochs by Adam (learning rate $10^{-3}$) on the negative log-likelihood
\begin{equation}
...
To confirm that the pipeline generalizes beyond equities, we apply it to the CBOE CBOE VIX log-return series
$R_t = \ln(X_t / X_{t-1})$ for $X = \text{VIX}$.
