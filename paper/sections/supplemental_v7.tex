...
\centering
\small
\caption{Walk-forward (quarterly CHMM-N refit) vs fixed-IS CHMM-N on JNJ and JPM at $K = 18$, 1000 paths (seed = 20260420).}
...
\subsection{Per-Ticker VIX-Conditioned Price-Simulation Figures}
\label{sec:price_sim_vix_appendix}

This appendix collects the per-ticker VIX-conditioned price-fan, terminal-distribution, and coupling-heatmap figures deferred from Section~\ref{sec:price_sim_vix} for the four non-body tickers JNJ, JPM, AAPL, and QQQ.
Plotting conventions follow Figures~\ref{fig:price_fan_spy_vix}, \ref{fig:price_terminal_hists_vix}, and \ref{fig:coupling_heatmaps} respectively.
Summary metrics for all four tickers are in Table~\ref{tab:price_sim_vix_metrics} in the main body.

\begin{figure}[h]
\centering
\begin{subfigure}[t]{0.22\textwidth}
    \includegraphics[width=\textwidth]{sections/figs/Fig-VIX-Coupling-JNJ.pdf}
    \caption{JNJ.}
\end{subfigure}
\begin{subfigure}[t]{0.22\textwidth}
    \includegraphics[width=\textwidth]{sections/figs/Fig-VIX-Coupling-JPM.pdf}
    \caption{JPM.}
\end{subfigure}
\begin{subfigure}[t]{0.22\textwidth}
    \includegraphics[width=\textwidth]{sections/figs/Fig-VIX-Coupling-AAPL.pdf}
    \caption{AAPL.}
\end{subfigure}
\begin{subfigure}[t]{0.22\textwidth}
    \includegraphics[width=\textwidth]{sections/figs/Fig-VIX-Coupling-QQQ.pdf}
    \caption{QQQ.}
\end{subfigure}
\caption{VIX-to-equity coupling matrices $C_i[s^V, s^E]$ (lag $h = 1$) for the four appendix tickers.}
\label{fig:coupling_heatmaps_appendix}
\end{figure}

\begin{figure}[h]
\centering
\begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth]{sections/figs/Fig-VIX-JNJ-PriceFan-N.pdf}
    \caption{CHMM-N.}
\end{subfigure}
\begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth]{sections/figs/Fig-VIX-JNJ-PriceFan-t.pdf}
    \caption{CHMM-t.}
\end{subfigure}
\begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth]{sections/figs/Fig-VIX-JNJ-PriceFan-L.pdf}
    \caption{CHMM-L.}
\end{subfigure}
\caption{JNJ VIX-conditioned price fan.}
\label{fig:price_fan_jnj_vix_appendix}
\end{figure}

\begin{figure}[h]
\centering
\begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth]{sections/figs/Fig-VIX-JNJ-TerminalDist-N.pdf}
    \caption{CHMM-N.}
\end{subfigure}
\begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth]{sections/figs/Fig-VIX-JNJ-TerminalDist-t.pdf}
    \caption{CHMM-t.}
\end{subfigure}
\begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth]{sections/figs/Fig-VIX-JNJ-TerminalDist-L.pdf}
    \caption{CHMM-L.}
\end{subfigure}
\caption{JNJ VIX-conditioned terminal-price distribution.}
\label{fig:terminal_jnj_vix_appendix}
\end{figure}

\begin{figure}[h]
\centering
\begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth]{sections/figs/Fig-VIX-JPM-PriceFan-N.pdf}
    \caption{CHMM-N.}
\end{subfigure}
\begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth]{sections/figs/Fig-VIX-JPM-PriceFan-t.pdf}
    \caption{CHMM-t.}
\end{subfigure}
\begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth]{sections/figs/Fig-VIX-JPM-PriceFan-L.pdf}
    \caption{CHMM-L.}
\end{subfigure}
\caption{JPM VIX-conditioned price fan.}
\label{fig:price_fan_jpm_vix_appendix}
\end{figure}

\begin{figure}[h]
\centering
\begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth]{sections/figs/Fig-VIX-JPM-TerminalDist-N.pdf}
    \caption{CHMM-N.}
\end{subfigure}
\begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth]{sections/figs/Fig-VIX-JPM-TerminalDist-t.pdf}
    \caption{CHMM-t.}
\end{subfigure}
\begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth]{sections/figs/Fig-VIX-JPM-TerminalDist-L.pdf}
    \caption{CHMM-L.}
\end{subfigure}
\caption{JPM VIX-conditioned terminal-price distribution.}
\label{fig:terminal_jpm_vix_appendix}
\end{figure}

\begin{figure}[h]
\centering
\begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth]{sections/figs/Fig-VIX-AAPL-PriceFan-N.pdf}
    \caption{CHMM-N.}
\end{subfigure}
\begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth]{sections/figs/Fig-VIX-AAPL-PriceFan-t.pdf}
    \caption{CHMM-t.}
\end{subfigure}
\begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth]{sections/figs/Fig-VIX-AAPL-PriceFan-L.pdf}
    \caption{CHMM-L.}
\end{subfigure}
\caption{AAPL VIX-conditioned price fan.}
\label{fig:price_fan_aapl_vix_appendix}
\end{figure}

\begin{figure}[h]
\centering
\begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth]{sections/figs/Fig-VIX-AAPL-TerminalDist-N.pdf}
    \caption{CHMM-N.}
\end{subfigure}
\begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth]{sections/figs/Fig-VIX-AAPL-TerminalDist-t.pdf}
    \caption{CHMM-t.}
\end{subfigure}
\begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth]{sections/figs/Fig-VIX-AAPL-TerminalDist-L.pdf}
    \caption{CHMM-L.}
\end{subfigure}
\caption{AAPL VIX-conditioned terminal-price distribution.}
\label{fig:terminal_aapl_vix_appendix}
\end{figure}

\begin{figure}[h]
\centering
\begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth]{sections/figs/Fig-VIX-QQQ-PriceFan-N.pdf}
    \caption{CHMM-N.}
\end{subfigure}
\begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth]{sections/figs/Fig-VIX-QQQ-PriceFan-t.pdf}
    \caption{CHMM-t.}
\end{subfigure}
\begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth]{sections/figs/Fig-VIX-QQQ-PriceFan-L.pdf}
    \caption{CHMM-L.}
\end{subfigure}
\caption{QQQ VIX-conditioned price fan.}
\label{fig:price_fan_qqq_vix_appendix}
\end{figure}

\begin{figure}[h]
\centering
\begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth]{sections/figs/Fig-VIX-QQQ-TerminalDist-N.pdf}
    \caption{CHMM-N.}
\end{subfigure}
\begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth]{sections/figs/Fig-VIX-QQQ-TerminalDist-t.pdf}
    \caption{CHMM-t.}
\end{subfigure}
\begin{subfigure}[t]{0.32\textwidth}
    \includegraphics[width=\textwidth]{sections/figs/Fig-VIX-QQQ-TerminalDist-L.pdf}
    \caption{CHMM-L.}
\end{subfigure}
\caption{QQQ VIX-conditioned terminal-price distribution.}
\label{fig:terminal_qqq_vix_appendix}
\end{figure}
