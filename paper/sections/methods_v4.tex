...
Monte Carlo simulation of \eqref{eq:regime_gbm} produces option prices under the CHMM-implied regime structure, yielding an implied volatility surface that inherits the discrete regime weights and persistence from the VIX-trained CHMM.
A detailed benchmark of this surface against a parametric stochastic-volatility model is outside the scope of this paper and is the subject of companion work led by our group.
