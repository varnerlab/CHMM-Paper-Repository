...
The heavy-tailed CHMM-t and CHMM-L variants close the kurtosis gap of the Gaussian CHMM (mean simulated excess kurtosis rises from 5.1 to values closer to the observed 7.7) while retaining the ACF and pass-rate fidelity of CHMM-N.
...
\input{sections/introduction_v6}
...
\input{sections/supplemental_v6}
