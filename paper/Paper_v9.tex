...
\title{Continuous Hidden Markov Models as a Digital Twin for Equity Returns:\\Gaussian, Student-t, and Laplace Emissions Trained by EM, with Cross-Asset Copula Composition and a Volatility-Index Generalization}
...
\input{sections/introduction_v9}

\section{Related Work}
\label{sec:related}
\input{sections/related_v9}

\section{Methods}
\label{sec:methods}
\input{sections/methods_v9}

\section{Empirical Study}
\label{sec:results}
\input{sections/results_v9}

\section{Discussion}
\label{sec:discussion}
\input{sections/discussion_v9}

\section{Conclusion}
\label{sec:conclusion}
\input{sections/conclusion_v9}
...
\input{sections/supplemental_v9}
